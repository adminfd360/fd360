...
import cp920 from "./assets/cp920.webp";
import cp930w from "./assets/cp930w.webp";
import cp960 from "./assets/cp960.webp";
import mp50 from "./assets/mp50.webp";
import mp54 from "./assets/mp54.webp";
import mp56 from "./assets/mp56.webp";
import mp58 from "./assets/mp58.webp";
import t31g from "./assets/t31g.webp";
import t31p from "./assets/t31p.webp";
import t48s from "./assets/t48s.webp";
import t53 from "./assets/t53w.webp";
import t53w from "./assets/t53w.webp";
import t54w from "./assets/t54w.webp";
import t57w from "./assets/t57w.webp";
import w53h from "./assets/w53h.webp";
import w53p from "./assets/w53p.webp";
import w56h from "./assets/w56h.webp";
import w59r from "./assets/w59r.webp";
import w60p from "./assets/w60p.webp";
import w73p from "./assets/w73p.webp";
import wh66 from "./assets/wh66.webp";
import t58a from "./assets/t58a.webp";
import vp59 from "./assets/vp59.webp";
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-4 gap-4 justify-items-center items-center">
        {phoneItems.map(({ title, image, description }, index) => (
          <motion.div
            ...
            className="bg-white rounded-md bg-opacity-40 bg-clip-padding backdrop-opacity-50 shadow-lg p-4 w-full h-full min-h-[292px] cursor-pointer hover:shadow-xl transition-shadow duration-300"
            onClick={() => handlePhoneClick({ title, image, description })}
          >
            <h2 className="text-gray-800 mt-4 font-custom text-xl">{title}</h2>
            <img
